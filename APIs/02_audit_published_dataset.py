    ...
    for trigger in under_review:
        ...
        with server.auth.sign_in(tableau_auth):
            ...
            for dataset in published:
                ...
                print(
                    f"Downloading {dataset.name} from {dataset.project_name} last updated on {dataset.updated_at}"
                )
                server.datasources.download(
                    dataset.id, download_path, include_extract=True, no_extract=None
                )
                ...
                downloaded = DoC.Datasource.from_file(
                    download_path + dataset.name + datasource_extension
                )
