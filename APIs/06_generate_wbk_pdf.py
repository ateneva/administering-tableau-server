...
def download_as_pdf(
    tableau_server, tableau_user, user_password, site_name, download_path, *args
):
    ...
    with server.auth.sign_in(tableau_auth):
        for item in generate_pdf:
            ...
            print(
                "\nThere are {} workbooks on site: ".format(
            ...
            for wbk in published:
                ...
                connection_info = [
                    connection.datasource_name for connection in wbk.connections
                ]
                ...
                if len(connection_info) > 0:
                    print(
                        ...
                        wbk.name,
                        "_",
                        wbk.connections[0].connection_type,
                        "_",
                        wbk.connections[0].id,
                        "_",
                        wbk.connections[0].username,
                        "_",
