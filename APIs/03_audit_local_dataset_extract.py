...
def audit_local_datasets(local_folder, *args):
    ...
    for i, r in enumerate(under_review):
        ...
        reviewed = DoC.Datasource.from_file(
            download_path + review + datasource_extension
        )
        ...
        calucalted_fields_file = (
            download_path + str(now) + "_" + review + "_calculated.json"
        )
        ...
        print(
            f"Check {audit_file} and {calucalted_fields_file} for further details...:\n"
        )


if __name__ == "__main__":
    audit_local_datasets(
        "C:/Users/angelinat/Desktop/", "customer", "2018-19 Arsenal Player Stats"
    )
