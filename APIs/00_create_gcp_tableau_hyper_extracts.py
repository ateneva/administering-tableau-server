...
def download_bucket_files(
    download_bucket_name, download_folder, download_file, file_format
):
...
def create_hyper_file_from_csv(full_path_to_csv, file_name):
    ...
    with HyperProcess(
        ...
        with Connection(
            ...
            print(
                f"The number of rows in table {hyper_table.table_name} is {count_in_hyper_table}."
            )
...
def publish_to_server(
    tableau_server_link, tableau_user, user_password, project_name, hyper_file
):
    ...
    with server.auth.sign_in(tableau_auth):
        ...
        print(
            f"Publishing of datasource '{hyper_file}' complete. Datasource ID: {datasource.id}"
        )


if __name__ == "__main__":
    export_to_bucket(
        "bigquery-public-data", "hacker_news", "stories", "hyper_extracts", "csv"
    )
    download_bucket_files(
        "hyper_extracts", "C:/Users/angelinat/Documents/data", "stories", "csv"
    )
    union_data(
        "stories",
        "C:/Users/angelinat/Documents/data",
        "C:/Users/angelinat/Documents/data/merged",
        "csv",
    )
    define_hyper_schema("stories_schema.json")
    try:
        create_hyper_file_from_csv(
            "C:/Users/angelinat/Documents/data/merged/stories.csv", "stories_extract"
        )
